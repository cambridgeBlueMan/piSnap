...
# Form implementation generated from reading ui file 'adjustmentsTabGui.ui'
#
...
class Ui_adjustments(object):
    def setupUi(self, adjustments):
        ...
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(30, 240, 721, 171))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(30, 440, 341, 201))
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.exposure_mode)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.flash_mode)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.meter_mode)
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(30, 30, 731, 191))
