...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.useZoomOnRecord.setEnabled(False)
        ...
        self.endRecWhenZoomEnds.setEnabled(False)
        ...
        self.thumbnailAsMv = QtWidgets.QListView(Form)
        self.thumbnailAsMv.setGeometry(QtCore.QRect(30, 10, 140, 600))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setItalic(True)
        self.thumbnailAsMv.setFont(font)
        self.thumbnailAsMv.setFlow(QtWidgets.QListView.TopToBottom)
        self.thumbnailAsMv.setViewMode(QtWidgets.QListView.IconMode)
        self.thumbnailAsMv.setObjectName("thumbnailAsMv")
        ...
        self.thumbnailAsMv.doubleClicked['QModelIndex'].connect(Form.thumbnailDoubleClicked)
