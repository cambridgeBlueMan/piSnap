...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.start.setGeometry(QtCore.QRect(100, 430, 61, 20))
        self.start.setObjectName("start")
        self.showStart = QtWidgets.QPushButton(Form)
        self.showStart.setGeometry(QtCore.QRect(10, 430, 61, 20))
        ...
        self.end.setGeometry(QtCore.QRect(90, 460, 61, 21))
        ...
        self.printDiag.setGeometry(QtCore.QRect(430, 470, 71, 21))
        self.printDiag.setObjectName("printDiag")
        self.zoomTableView = QtWidgets.QTableView(Form)
        self.zoomTableView.setGeometry(QtCore.QRect(10, 520, 501, 121))
        self.zoomTableView.setObjectName("zoomTableView")
        self.delRow = QtWidgets.QPushButton(Form)
        self.delRow.setGeometry(QtCore.QRect(200, 480, 51, 21))
        self.delRow.setObjectName("delRow")
        self.playRow = QtWidgets.QPushButton(Form)
        self.playRow.setGeometry(QtCore.QRect(280, 480, 51, 21))
        self.playRow.setObjectName("playRow")
        ...
        self.playRow.clicked.connect(Form.playSelectedRow)
    ...
    def retranslateUi(self, Form):
        ...
        self.playRow.setText(_translate("Form", "play row"))
