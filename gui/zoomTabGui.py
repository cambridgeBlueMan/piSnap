...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.getSpeed.setMinimum(0)
        self.getSpeed.setMaximum(100)
        self.getSpeed.setProperty("value", 75)
        ...
        self.playRows.setGeometry(QtCore.QRect(370, 430, 31, 31))
        ...
        self.nextZoom.setGeometry(QtCore.QRect(410, 430, 31, 30))
        self.nextZoom.setWhatsThis("")
        self.nextZoom.setObjectName("nextZoom")
        self.restartZoom = QtWidgets.QPushButton(Form)
        self.restartZoom.setGeometry(QtCore.QRect(320, 430, 31, 30))
        self.restartZoom.setObjectName("restartZoom")
        ...
        self.zTblView.clicked['QModelIndex'].connect(Form.showThisZoomStart)
